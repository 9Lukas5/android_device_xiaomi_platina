...
LOCAL_C_INCLUDES := \
    ...
    device/xiaomi/platina/qcom-caf/audio/hal \
...
LOCAL_C_INCLUDES := \
    ...
    $(call include-path-for, audio-route) \
    device/xiaomi/platina/qcom-caf/audio/hal \
    device/xiaomi/platina/qcom-caf/audio/hal/$(AUDIO_PLATFORM) \
    $(call include-path-for, audio-effects)
...
PRIMARY_HAL_PATH := device/xiaomi/platina/qcom-caf/audio/hal
AUDIO_PLATFORM := $(TARGET_BOARD_PLATFORM)
